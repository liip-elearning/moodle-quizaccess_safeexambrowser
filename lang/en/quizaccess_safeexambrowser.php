...
$string['allowedbrowserkeys_help'] = 'In this box you can enter the allowed browser exam keys for versions of Safe Exam Browser that are permitted to access this quiz. If no keys are entered, then no specific exam key is required for this quiz.';
